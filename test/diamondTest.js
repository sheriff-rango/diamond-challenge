...
describe('DiamondTest', async function () {
  ...
  it('should add TokenAvgPrice functions', async () => {
    ...
    addresses.push(tokenAvgPrice.address)
    const selectors = getSelectors(tokenAvgPrice).remove(['supportsInterface(bytes4)'])
    tx = await diamondCutFacet.diamondCut(
      [{
        facetAddress: tokenAvgPrice.address,
    ...
    result = await diamondLoupeFacet.facetFunctionSelectors(tokenAvgPrice.address)
    assert.sameMembers(result, selectors)
  })

  it('should test function call', async () => {
    const tokenAvgPrice = await ethers.getContractAt('TokenAvgPrice', diamondAddress)
    await tokenAvgPrice.setTokenPrice('2021-08-10', 10)
    await tokenAvgPrice.setTokenPrice('2021-08-11', 11)
    await tokenAvgPrice.setTokenPrice('2021-08-12', 12)
    await tokenAvgPrice.setTokenPrice('2021-08-13', 13)
    
    let savedTokenPrice = await tokenAvgPrice.returnTokenPrice('2021-08-10')
    console.log(1, savedTokenPrice)
    savedTokenPrice = await tokenAvgPrice.returnTokenPrice('2021-08-11')
    console.log(2, savedTokenPrice)
    savedTokenPrice = await tokenAvgPrice.returnTokenPrice('2021-08-12')
    console.log(3, savedTokenPrice)
    savedTokenPrice = await tokenAvgPrice.returnTokenPrice('2021-08-13')
    console.log(4, savedTokenPrice)
    savedTokenPrice = await tokenAvgPrice.returnTokenPrice('2021-08-14')
    console.log(5, savedTokenPrice)

    let tokenPricePeriod = await tokenAvgPrice.returnTokenPricePeriod('2021-08-11', '2021-08-13')
    console.log(6, tokenPricePeriod)
  })
